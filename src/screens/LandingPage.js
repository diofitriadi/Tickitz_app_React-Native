...
import { SafeAreaView ,ScrollView, View, Text, Image, StyleSheet, Pressable, TouchableOpacity, TextInput } from "react-native";
    ...
    <SafeAreaView>
      ...
      {/* Landing Page */}
        <View style={{backgroundColor: '#E5E5E5', padding: 30}}>
          <Text style={{fontSize: 16}}>Nearest Cinema, Newest Movie</Text>
          <Text style={{fontSize: 35, fontWeight: 'bold', color: '#5F2EEA'}}>Find out now!</Text>
        </View>
        <View style={{backgroundColor: '#E5E5E5', height: 550}}>
